...
- Rollback validation reported valid (one expected rebuild/rollback warning), rolled back to deployment `961c09ff-fd71-44d7-ac2a-b66e1007181b` via rollback deployment `66e6ef16-dbb6-4d5e-8c22-c66ef57ce341`, remained fully ready, and restored the accepted build without database/object/worker-state loss.
