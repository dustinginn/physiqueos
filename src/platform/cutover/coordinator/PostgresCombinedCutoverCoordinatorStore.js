...
function environment(value) { const result = typeof value === "string" ? value : ""; if (!/^[A-Za-z0-9][A-Za-z0-9._:-]{0,127}$/.test(result)) throw coordinatorError(CoordinatorErrorCode.IDENTITY_MISMATCH, "environment is invalid."); return result; }
