...
describe("WeeklyBriefingScreen V5.1",()=>{
  ...
  it("allows the shared narrative contract to name the canonical forward-looking section",()=>{expect(source).toContain('cards.coachInsight.title??"Coach’s Insight"');});
