...
export function resolveActiveGoalConfidencePresentation({
  ...
  const presentation = {
    ...
    guardrailState: assessment.guardrailState ?? null,
    freshnessState: assessment.freshnessState ?? null,
    completenessState: assessment.completenessState ?? null,
    contradictions: structuredClone(assessment.contradictions ?? []),
...
function unavailable(goal, phase, reason) {
  return Object.freeze({
    ...
    narrativeSummary: null, narrativeDetail: null, narrativeSections: null,
    goalAchievementState: null, strategyConfidence: null,
    strategyEffectiveness: null, guardrailState: null,
    freshnessState: null, completenessState: null, contradictions: [],
