export const FOUNDER_ALPHA_TRAINING_EXERCISES = [
  ...
  exercise("seated_cable_row", "Seated Cable Row", ["seated cable row", "seated cable rows", "seater cable row", "seater cable rows", "cable row", "cable rows", "seated row", "seated rows", "cable machine seated row", "seated mid cable row", "cable machine seated mid cable row"], "cable", "Back", ["Mid Back", "Lats", "Biceps"], "Horizontal Pull"),
  ...
  exercise("cable_machine_front_raise", "Cable Machine Front Raise", ["cable machine front raise", "cable machine front raises"], "cable", "Shoulders", ["Front Delts"], "Front Raise"),
