...
export default async function MonthlyBriefingPreviewInspectorPage({ searchParams }) {
  ...
  const summary = {
    route: "/briefings/monthly/preview/2026-07-01/inspector",
    fixture: fixtureKey,
    fixtureId: selectedFixture.fixtureId,
    fixtureVersion: selectedFixture.fixtureVersion,
    routeSafePreview: fixtureNarrative.id,
    ...
    <main className="app-surface min-h-screen overflow-x-hidden p-4">
      <section className="mb-4 rounded border bg-[var(--surface-elevated)] p-3">
        ...
        <p className="mt-1 text-sm">
          <a className="mr-3 text-blue-600 underline" href="/briefings/monthly/preview/2026-07-01/inspector?fixture=julyContinuation">July synthetic transition</a>
          <a className="text-blue-600 underline" href="/briefings/monthly/preview/2026-07-01/inspector?fixture=ordinaryMonth">Ordinary-month control</a>
        </p>
      </section>
