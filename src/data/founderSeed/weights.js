...
export const founderWeightEntries = [
  ...
  createFounderWeight("2026-06-14", 171.7),
  createFounderWeight("2026-06-15", 171.6),
  createFounderWeight("2026-06-16", 170.5),
  createFounderWeight("2026-06-17", 170.3),
  createFounderWeight("2026-06-18", 170.9),
  createFounderWeight("2026-06-19", 170.8),
  createFounderWeight(
    "2026-06-20",
    169.7,
    "DEXA scan performed the same day. Morning home scale reading. Do not replace the DEXA body weight contained in the scan."
  ),
  createFounderWeight("2026-06-21", 170.3),
  createFounderWeight("2026-06-22", 168.8),
  createFounderWeight("2026-06-23", 169.2),
  createFounderWeight("2026-06-24", 168.9),
  ...
  createFounderWeight("2026-07-01", 167.5),
  createFounderWeight("2026-07-02", 166.3),
  createFounderWeight("2026-07-03", 167.5),
];
