...
describe("Phase 3 bounded read models", () => {
  it("requires a principal and creates stable, client-safe envelopes for every surface", async () => {
    const loaders = Object.fromEntries(Object.values(Phase3ReadModel).map((model) => [model, vi.fn(async ({ principal: actor }) => ({ id: model, owner: actor.userId, href: "/profile", optional: undefined, filePath: "C:/secret", repository: {} }))]));
