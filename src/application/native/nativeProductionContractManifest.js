...
export const nativeProductionContractManifest = Object.freeze({
  ...
  healthKitIngestion: Object.freeze({
    ...
    identity: "server hash of source bundle, observation type, and immutable HealthKit external ID; daily snapshots also include device and source revision",
    occurrenceTime: "required and stored separately from server receipt time",
    ...
    queryCursor: "device-owned and never required by the server contract",
  }),
  reads,
  writes,
});
