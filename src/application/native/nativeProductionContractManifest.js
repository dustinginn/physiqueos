...
const writes = Object.freeze([
  ...
  write(Phase3Command.INGEST_HEALTHKIT_OBSERVATIONS, ["batchId", "observations"], "source observations remain separate; daily totals may canonicalize, workout Evidence eligibility is not decided by ingestion"),
