...
function PhaseRow({ phase }) {
  ...
  // Completed phases get a subtler tint than active/upcoming ones — enough to read as
  // "this phase has its own identity" without looking like the currently active phase.
  const tintedPhase = highlightedPhase || completed;
