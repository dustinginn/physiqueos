...
app_files = [
    ...
    ("Contracts", "GoalsSandboxModel.swift"),
    ...
    ("Contracts", "ActivityReadModel.swift"),
    ("Contracts", "NutritionReadModel.swift"),
    ("Contracts", "NutritionReportingReadModel.swift"),
    ("Contracts", "NutritionReportingCalculator.swift"),
    ...
    ("Networking", "GoalsSandboxStore.swift"),
    ("Networking", "OperatingPlanSandboxStore.swift"),
    ("Networking", "BriefingSandboxStore.swift"),
    ...
    ("Contracts", "StagedPhotoIntakeModels.swift"),
    ("Contracts", "ProgressPhotoPoseContractData.swift"),
    ("Contracts", "ProgressPhotoPoseContract.swift"),
    ("Networking", "StagedPhotoIntakeStore.swift"),
    ("Networking", "PhotoAnalysisDerivativeGenerator.swift"),
    ("Networking", "StagedPhotoIntakeCoordinator.swift"),
    ...
    ("Networking", "TrainingStrategyAPI.swift"),
    ("Networking", "PeptideSupportAPI.swift"),
    ...
    ("SharedUI", "ChartInteraction.swift"),
    ...
    ("Presentation/Briefings", "MidweekBriefingSections.swift"),
    ("Presentation/Briefings", "MonthlyBriefingSections.swift"),
    ("Presentation/Briefings", "DEXABriefingSections.swift"),
    ...
    ("Presentation/Goals", "GoalsView.swift"),
    ("Presentation/Goals", "GoalsViewModel.swift"),
    ("Presentation/Goals", "GoalDetailView.swift"),
    ("Presentation/Goals", "CompletedGoalDetailView.swift"),
    ("Presentation/Goals", "GoalPhaseDetailView.swift"),
    ("Presentation/Goals", "GoalStrategyView.swift"),
    ("Presentation/Goals", "GoalEditWizardView.swift"),
    ("Presentation/Goals", "GoalTransitionWizardView.swift"),
    ("Presentation/Goals", "GoalProtocolTransitionView.swift"),
    ("Presentation/Goals", "GoalProtocolCategoryEditorView.swift"),
    ("Presentation/Goals", "GoalTransitionFinalReviewView.swift"),
    ("Presentation/Goals", "PhaseTransitionView.swift"),
    ("Presentation/OperatingPlan", "OperatingPlanComponents.swift"),
    ("Presentation/OperatingPlan", "OperatingPlanLandingView.swift"),
    ("Presentation/OperatingPlan", "OperatingPlanStrategyDetailView.swift"),
    ("Presentation/OperatingPlan", "OperatingPlanStrategyEditorView.swift"),
    ("Presentation/OperatingPlan", "OperatingPlanProtocolDomainView.swift"),
    ("Presentation/OperatingPlan", "OperatingPlanPeptideExecutionView.swift"),
    ("Presentation/OperatingPlan", "OperatingPlanRecoverySupportView.swift"),
    ("Presentation/OperatingPlan", "OperatingPlanSupportScheduleEditor.swift"),
    ("Presentation/OperatingPlan", "OperatingPlanSupplementSupportView.swift"),
    ...
    ("Presentation/OperatingPlan", "OperatingPlanDexaAppointmentView.swift"),
    ("Presentation/OperatingPlan", "ProtocolBuilderShell.swift"),
    ...
    ("Presentation/Evidence", "ActivityDayViewModel.swift"),
    ("Presentation/Evidence", "NutritionHistoryView.swift"),
    ("Presentation/Evidence", "NutritionHistoryViewModel.swift"),
    ("Presentation/Evidence", "NutritionDayView.swift"),
    ("Presentation/Evidence", "NutritionDayViewModel.swift"),
    ("Presentation/Evidence", "NutritionReportingView.swift"),
    ("Presentation/Evidence", "NutritionReportingViewModel.swift"),
    ("Presentation/Evidence", "NutritionReportingChartViews.swift"),
    ("Presentation/Evidence", "NutritionReportingRowViews.swift"),
    ...
    ("Presentation/Evidence", "PhotosHistoryViewModel.swift"),
    ("Presentation/Evidence", "TimelineView.swift"),
    ("Presentation/Evidence", "TimelineViewModel.swift"),
    ("Presentation/Evidence", "EvidenceReviewDetailView.swift"),
...
# N0 HealthKit files are allocated after every established project object so
# adding the capability shell does not renumber unrelated Build 41 objects.
late_app_files = [
    ("Contracts", "HealthKitCapabilityModels.swift"),
    ("Networking", "HealthKitTypeRegistry.swift"),
    ("Networking", "HealthKitService.swift"),
...
test_files = [
    ...
    ("PhysiqueOSTests", "GoalsSandboxStoreTests.swift"),
    ("PhysiqueOSTests", "BriefingReadModelTests.swift"),
    ("PhysiqueOSTests", "DEXABriefingTests.swift"),
    ("PhysiqueOSTests", "PhotoBriefingTests.swift"),
    ("PhysiqueOSTests", "StagedPhotoIntakeTests.swift"),
    ("PhysiqueOSTests", "ProgressPhotoPoseContractTests.swift"),
    ...
    ("PhysiqueOSTests", "WeightReadModelTests.swift"),
    ("PhysiqueOSTests", "DEXAReadModelTests.swift"),
    ("PhysiqueOSTests", "PhotosReadModelTests.swift"),
    ("PhysiqueOSTests", "EnergyReadModelTests.swift"),
    ("PhysiqueOSTests", "ChartInteractionTests.swift"),
...
for group, fname in late_test_files:
    I(f"fileref:{group}/{fname}")
    I(f"buildfile:{group}/{fname}")
for group, fname in late_reference_only_files:
    I(f"fileref:{group}/{fname}")
...
app_framework_build_ids = "\n".join(
    f"\t\t\t\t{I(f'buildfile:framework:{framework}')} /* {framework} in Frameworks */,"
    for framework in system_frameworks
)
...
\t\t\t\tCODE_SIGN_ENTITLEMENTS = "PhysiqueOS/Supporting/PhysiqueOS.entitlements";
