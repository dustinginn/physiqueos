...
final class TrainingLoggerTests: XCTestCase {
    ...
    func testAppDeclaresExemptEncryptionAndBuildTwentySixInSourceControlledConfiguration() throws {
        ...
        XCTAssertEqual(Bundle.main.object(forInfoDictionaryKey: "CFBundleVersion") as? String, "26")
