...
final class TrainingLoggerTests: XCTestCase {
    ...
    func testAppDeclaresExemptEncryptionAndBuildThirtyEightInSourceControlledConfiguration() throws {
        ...
        XCTAssertEqual(Bundle.main.object(forInfoDictionaryKey: "CFBundleVersion") as? String, "38")
