...
final class TrainingLoggerTests: XCTestCase {
    ...
    func testAppDeclaresExemptEncryptionAndBuildThirtySevenInSourceControlledConfiguration() throws {
        ...
        XCTAssertEqual(Bundle.main.object(forInfoDictionaryKey: "CFBundleVersion") as? String, "37")
