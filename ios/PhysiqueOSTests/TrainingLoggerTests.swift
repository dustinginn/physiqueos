...
final class TrainingLoggerTests: XCTestCase {
    ...
    func testAppDeclaresExemptEncryptionAndBuildFortyNineInSourceControlledConfiguration() throws {
        ...
        XCTAssertEqual(Bundle.main.object(forInfoDictionaryKey: "CFBundleVersion") as? String, "49")
