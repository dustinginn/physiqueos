...
Assert-True ($configurationText -match "phase7b-wp2b-replica-config-r2-6cce4f4197ae4651a33ec123825326f9") 'unique replacement one-shot authorization identity bound'
Assert-True (-not ($configurationText -match "authorizationLiteral\s*=\s*'phase7b-wp2b-replica-config-6cce4f4197ae4651a33ec123825326f9'")) 'consumed authorization identity cannot invoke corrected source'
