...
try {
  ...
  const [policyRecord, observations, canonicalWorkouts, links, canonicalEvidenceObjects] = await Promise.all([
  ...
  const summary = summarizeHealthKitWorkoutCanary({
    policyRecord, observations, canonicalWorkouts, links, canonicalEvidenceObjects,
