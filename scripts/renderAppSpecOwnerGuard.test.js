...
function productTemplateEnv(overrides = {}) {
  return {
    ...
    EXPECTED_PRODUCTION_BUILD_ID: "test-production-build",
    EXPECTED_FOUNDER_REVISION: "142",
    EXPECTED_FOUNDER_SHA256: "a".repeat(64),
    EXPECTED_MEDIA_COUNT: "402",
    EXPECTED_MEDIA_BYTES: "288919315",
    EXPECTED_MEDIA_INVENTORY_SHA256: "b".repeat(64),
    EXPECTED_ROLLBACK_SOURCE_COMMIT: "f8e63bd023d611c008d1bf8a04fbf6f34424cbde",
    EXPECTED_ROLLBACK_BUILD_ID: "test-production-build",
    EXPECTED_FINAL_BACKUP_SHA256SUMS_SHA256: "c".repeat(64),
